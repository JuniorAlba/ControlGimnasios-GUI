...
#include "coach.h"
#include <wx/msgdlg.h>
HijaCoachsAgregar::HijaCoachsAgregar(manage *aux ,wxWindow *parent) : BaseCoachsAgregar(parent), m_manage(aux) {
...
*
* Al clickear el boton carga los datos de las celdas en un coach, este se
* guarda en el vector de coach de la clase manage y devuelve EndModal(1)
*
*/
void HijaCoachsAgregar::ClickAceptarRegistro( wxCommandEvent& event )  {
	...
	coach ch(nombre,apellido,email,sexo,telefono,direccion,localidad,DNI,
			 dia,mes,anio,
			 CBU,alias);
...
void HijaCoachsAgregar::ClickCancelarRegistro( wxCommandEvent& event )  {
	EndModal(0);
}
